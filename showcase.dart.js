...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _store(el) {
      var h = $._nextHandle;
      $._nextHandle = h + 1;
      $._handles.$indexSet(0, h, el);
      return h;
    },
    _log(msg) {
      var el = A._asJSObjectQ(A._asJSObject(init.G.document).getElementById("output"));
      if (el != null)
        el.textContent = A.S(A._asStringQ(el.textContent)) + msg + "\n";
      A.printString(msg);
    },
    _clearOutput() {
      var el = A._asJSObjectQ(A._asJSObject(init.G.document).getElementById("output"));
    ...
    _clearSandbox() {
      var el = A._asJSObjectQ(A._asJSObject(init.G.document).getElementById("sandbox"));
      if (el != null)
        el.innerHTML = "";
      $._handles.clear$0(0);
      $._nextHandle = 1;
    ...
    _dispatch(fnName, args) {
      var $async$goto = 0,
        ...
        $async$returnValue, tag, t1, h, text, parentH, childH, $parent, child, selector, el, prop, val, attr, html, key, msg, $async$temp1, $async$temp2, $async$temp3;
          ...
          switch ($async$goto) {
            ...
            case 5:
              ...
              if (J.get$isNotEmpty$asx(args)) {
                ...
                tag = A._asString(args[0]);
              } else
                tag = "div";
              $async$returnValue = A._store(A._asJSObject(A._asJSObject(init.G.document).createElement(tag)));
              // goto return
              $async$goto = 1;
              break;
            case 6:
              ...
              text = A._asString(args[1]);
              t1 = $._handles.$index(0, h);
              if (t1 != null)
                t1.textContent = text;
            ...
            case 7:
              ...
              childH = A._asInt(args[1]);
              $parent = $._handles.$index(0, parentH);
              child = $._handles.$index(0, childH);
              if ($parent != null && child != null)
                A._asJSObject($parent.appendChild(child));
              $async$returnValue = null;
              // goto return
              $async$goto = 1;
              break;
            case 8:
              ...
              selector = A._asString(args[0]);
              el = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector(selector));
              if (el == null) {
                $async$returnValue = null;
                // goto return
                $async$goto = 1;
            ...
            case 9:
              ...
              prop = A._asString(args[1]);
              if (2 >= t1) {
                $async$returnValue = A.ioore(args, 2);
                // goto return
                $async$goto = 1;
                break;
              }
              val = A._asString(args[2]);
              el = $._handles.$index(0, h);
              if (el != null)
                A._asJSObject(el.style).setProperty(prop, val);
              $async$returnValue = null;
              // goto return
              $async$goto = 1;
              break;
            ...
            case 15:
              ...
              key = A._asString(args[0]);
              $async$returnValue = A._asStringQ(A._asJSObject(A._asJSObject(init.G.window).localStorage).getItem(key));
              // goto return
              $async$goto = 1;
              break;
            case 16:
              ...
              val = A._asString(args[1]);
              A._asJSObject(A._asJSObject(init.G.window).localStorage).setItem(key, val);
              $async$returnValue = null;
              // goto return
              $async$goto = 1;
              break;
            ...
            case 18:
              ...
              if (J.get$isNotEmpty$asx(args)) {
                ...
                msg = "";
              A._asJSObject(init.G.window).alert(msg);
              $async$returnValue = null;
              // goto return
              $async$goto = 1;
              break;
      ...
      return A._asyncStartSync($async$_dispatch, $async$completer);
    },
    _runWithHostFunctions(code) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], fnName, fnArgs, value, e, t4, t5, fnArgs0, exception, t6, extFnsJson, t1, t2, t3, result, $async$exception, $async$temp1, $async$temp2;
      var $async$_runWithHostFunctions = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              extFnsJson = B.C_JsonCodec.encode$2$toEncodable(B.List_Fzp, null);
              t1 = init.G;
              t2 = type$.String;
              ...
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t1.DartMontyBridge.start(code, extFnsJson)), t2), $async$_runWithHostFunctions);
            case 3:
              // returning from await.
            ...
            case 4:
              ...
              $async$handler = 7;
              $async$goto = 10;
              return A._asyncAwait(A._dispatch(fnName, fnArgs), $async$_runWithHostFunctions);
            case 10:
              // returning from await.
              value = $async$result;
              $async$temp1 = t3;
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 11;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t1.DartMontyBridge.resume(B.C_JsonCodec.encode$2$toEncodable(value, null))), t2), $async$_runWithHostFunctions);
            case 11:
              // returning from await.
              result = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              $async$handler = 2;
            ...
            case 12:
              ...
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 15;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t1.DartMontyBridge.resumeWithError(B.C_JsonCodec.encode$2$toEncodable(J.toString$0$(e), null))), t2), $async$_runWithHostFunctions);
            case 15:
              // returning from await.
              result = $async$temp1._as($async$temp2.decode$2$reviver($async$result, null));
              // goto join
      ...
      return A._asyncStartSync($async$_runWithHostFunctions, $async$completer);
    },
    _populateDemoSelector() {
      var t3, labels, t4, t5, option, t6,
        t1 = init.G,
        t2 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("demo-select"));
      t2.toString;
      t2.innerHTML = '<option value="">-- Select a Demo --</option>';
      t3 = type$.String;
      labels = A.LinkedHashMap_LinkedHashMap$_literal(["hello", "Hello from Python", "altar", "The Sacred Altar (ASCII)", "todo", "The Dart Commandments", "counter", "Persistent Pilgrimage Counter", "dashboard", "Dart Evangelism Dashboard"], t3, t3);
      for (t3 = B.Map_fIpi0.get$entries(), t4 = t3.$ti, t3 = new A._SyncStarIterator(t3._outerHelper(), t4._eval$1("_SyncStarIterator<1>")), t4 = t4._precomputed1; t3.moveNext$0();) {
        t5 = t3._async$_current;
        if (t5 == null)
          t5 = t4._as(t5);
        option = A._asJSObject(A._asJSObject(t1.document).createElement("option"));
        t5 = t5.key;
        option.value = t5;
        t6 = labels.$index(0, t5);
        t5 = t6 == null ? t5 : t6;
        option.textContent = t5;
        A._asJSObject(t2.appendChild(option));
      }
      t2.addEventListener("change", A._functionToJS1(new A._populateDemoSelector_closure(t2)));
    },
    _runCode() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], statusEl, sw, result, usage, mem, time, stack, e, sw0, mem0, time0, stack0, t2, exception, t1, code, $async$exception;
      var $async$_runCode = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              code = B.JSString_methods.trim$0(A._asString(A._asJSObjectQ(A._asJSObject(t1.document).getElementById("editor")).value));
              ...
              A._clearOutput();
              A._clearSandbox();
              t1 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("status"));
              t1.toString;
              statusEl = t1;
              statusEl.textContent = "Running...";
              A._asJSObject(statusEl.style).color = "#dcdcaa";
              sw0 = new A.Stopwatch();
              ...
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait(A._runWithHostFunctions(code), $async$_runCode);
            case 7:
              // returning from await.
              result = $async$result;
              t1 = sw;
      ...
      return A._asyncStartSync($async$_runCode, $async$completer);
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              t2 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("status"));
              t2.toString;
              t2.textContent = "Initializing Monty WASM...";
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t1.DartMontyBridge.init()), type$.bool), $async$main);
            case 3:
              // returning from await.
              if (!$async$result) {
                t2.textContent = "Failed to initialize Monty WASM";
                A._asJSObject(t2.style).color = "#f44747";
                // goto return
                $async$goto = 1;
                break;
              }
              t2.textContent = "Ready. Choose a demo or write Python.";
              A._asJSObject(t2.style).color = "#569cd6";
              A._populateDemoSelector();
              t2 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("run-btn"));
              t2.toString;
              t2.addEventListener("click", A._functionToJS1(new A.main_closure()));
              t2 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("clear-btn"));
              t2.toString;
              t2.addEventListener("click", A._functionToJS1(new A.main_closure0()));
              t2 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("editor"));
              t2.toString;
              t2.addEventListener("keydown", A._functionToJS1(new A.main_closure1()));
              t2 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("editor"));
              t2.toString;
              t2.value = B.JSString_methods.trim$0(string$.app___);
              t1 = A._asJSObjectQ(A._asJSObject(t1.document).getElementById("demo-select"));
              t1.toString;
              t1.value = "altar";
            case 1:
              // return
  ...
  A._populateDemoSelector_closure.prototype = {
    call$1(e) {
      ...
      if (key.length !== 0 && B.Map_fIpi0.containsKey$1(key)) {
        t1 = A._asJSObjectQ(A._asJSObject(init.G.document).getElementById("editor"));
        t1.toString;
        t2 = B.Map_fIpi0.$index(0, key);
        t2.toString;
  ...
  A.main_closure0.prototype = {
    call$1(e) {
      ...
      A._clearOutput();
      A._clearSandbox();
      t1 = A._asJSObjectQ(A._asJSObject(init.G.document).getElementById("status"));
      t1.toString;
      t1.textContent = "Cleared. The altar awaits.";
      A._asJSObject(t1.style).color = "#569cd6";
    },
    $signature: 1
  };
  A.main_closure1.prototype = {
    call$1(e) {
      var t1;
      A._asJSObject(e);
      if (A._asString(e.key) === "Enter")
        t1 = A._asBool(e.ctrlKey) || A._asBool(e.metaKey);
      else
        t1 = false;
      if (t1) {
        e.preventDefault();
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.MapBase_mapToString_closure, A._JsonStringifier_writeMap_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(JSObject)", "~(@)", "~(~())", "int()", "@(@)", "Null(@)", "Null()", "~(Object?,Object?)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)"],
...
;
  ...
  (function staticFields() {
    ...
    $._nextHandle = 1;
    $._handles = A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.JSObject);
  })();
...
//# sourceMappingURL=showcase.dart.js.map
